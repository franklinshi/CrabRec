...
public class EnjoyshopToolBar extends Toolbar {
    ...
    public EnjoyshopToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs!=null){
            ...
            boolean isShowRight= a.getBoolean(R.styleable.EnjoyshopToolBar_isShowRightIcon, false);
            if (isShowRight) {
    ...
    private void initView() {
        if(mView==null) {
            ...
            //设置布局属性
            android.support.v7.widget.Toolbar.LayoutParams lp = new android.support.v7.widget.Toolbar.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup
                    .LayoutParams.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL);
            addView(mView, lp);
        }
    }

    //忽视lint的minsdkversion
