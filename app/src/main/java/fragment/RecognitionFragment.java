 ...
 */
public class RecognitionFragment extends TakePhotoFragment {
    TakePhoto takePhoto;
    ...
    String requestUrl = "http://47.102.146.191/validateCrabSurfMobile1/";
    ...
    private void init(){
        ...
        takePic1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getContext(), CameraActivity1.class);
