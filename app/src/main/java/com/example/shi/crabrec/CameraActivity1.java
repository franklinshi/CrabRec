...
import static fragment.ValidateFragment.takeSuccessNew;
...
public class CameraActivity1 extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private void init() {
        ...
        mCenterRect = DisplayUtils.createCenterRect(this, new Rect(10, 100, 10, 200));
...
//                SdcardUtils.saveBitmap2SD(scaleBitmap, "411524", 100000002 + "");
                ...
                SdcardUtils.saveBitmap2SDMy(bitmap,getImageCropUri());

            } else Toast.makeText(CameraActivity1.this, "未检测到SD卡", Toast.LENGTH_SHORT).show();
            //customCompressImage();
            ...
            finish();
            RecognitionFragment.takeSuccessNew();
        }
    };
    //获得照片的输出保存Uri
